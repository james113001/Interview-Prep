...
class TicTacToe:
    ...
    def __init__(self, n: int):
        self.n = n
        # instantiate running sum for all orientations of tictactoe
        #n rows and columns
        self.rows = [0] * n
        self.cols = [0] * n
        self.diagonal = 0
    ...
    def move(self, row: int, col: int, player: int) -> int:
        ...
        if (abs(self.rows[row]) == n or
            ...
            return player
        return 0
#o(n) time for initialization, o(1) time for each move, o(n) space for storing the running sums of rows and columns
