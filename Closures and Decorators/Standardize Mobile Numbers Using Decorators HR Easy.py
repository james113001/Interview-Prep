...
#O Complexity: O(n log n) where n is the number of mobile numbers. 
# The sorting operation dominates the time complexity. 
# The space complexity is O(n) for storing the formatted mobile numbers in a new list.